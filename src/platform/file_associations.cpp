...
const QVector<AssociationSpec>& association_specs() {
	static const QVector<AssociationSpec> specs = {
	  ...
	  {"bsp", "BSP Map", QColor("#7E57C2"), AssociationCategory::Asset},
	  {"map", "Source Map", QColor("#5E35B1"), AssociationCategory::Asset},
	  {"proc", "PROC Map", QColor("#3949AB"), AssociationCategory::Asset},
	  ...
	  {"cfg", "CFG Script", QColor("#455A64"), AssociationCategory::Asset},
	  {"shader", "Shader Script", QColor("#6A1B9A"), AssociationCategory::Asset},
	  {"menu", "Menu Script", QColor("#0277BD"), AssociationCategory::Asset},
	  {"def", "Definition Script", QColor("#00838F"), AssociationCategory::Asset},
	  {"mtr", "Material Script", QColor("#7B1FA2"), AssociationCategory::Asset},
	  {"txt", "Text File", QColor("#546E7A"), AssociationCategory::Asset},
	  ...
	  {"dm2", "DM2 Demo", QColor("#6D4C41"), AssociationCategory::Asset},
	  {"aas", "AAS Navigation", QColor("#00838F"), AssociationCategory::Asset},
	  {"qvm", "QVM Bytecode", QColor("#3949AB"), AssociationCategory::Asset},
	  {"crc", "CRC Manifest", QColor("#546E7A"), AssociationCategory::Asset},
	  {"tag", "TAG Model Data", QColor("#795548"), AssociationCategory::Asset},
	  {"mdx", "MDX Model Data", QColor("#4E342E"), AssociationCategory::Asset},
	  {"mds", "MDS Model Data", QColor("#5D4037"), AssociationCategory::Asset},
	  {"skc", "SKC Animation", QColor("#6D4C41"), AssociationCategory::Asset},
	  {"ska", "SKA Animation", QColor("#8D6E63"), AssociationCategory::Asset},
	};
	return specs;
}
