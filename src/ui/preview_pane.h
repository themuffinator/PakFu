...
public:
	...
	void show_cfg_text(const QString& title, const QString& subtitle, const QString& text);
...
private:
	...
	CfgSyntaxHighlighter* cfg_highlighter_ = nullptr;
};
